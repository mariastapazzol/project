...
localStorage.setItem(
  'token',
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE2ODQ0MzAzMDEsImV4cCI6MTcxNTk2NjMwMSwic3ViIjoiNzg2OTMxZmEtMTk4MC00M2U5LTg4MGQtMTM2NGY1ODQ4ZmFjIn0.UbSI417wcHNWHg-XLGBpMcBDf0ZQrigC02yp9zwaOn0'
);
...
const validateUserSchema = z.object({
  ...
  password: z
    .string()
    .nonempty('Este campo é obrigatório')
    .min(5, 'Você não atingiu o número de carácteres'),
});
